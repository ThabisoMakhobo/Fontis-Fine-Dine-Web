...
// Check if a user is logged in, otherwise treat as guest
$user_id = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : null;

// Handle add-to-cart action only if logged in
...
<section class="home">
   <div class="content">
      <h3>Feed Your Curiosity, Grow Your Mind.</h3>
...
<section class="products">
   ...
   <div class="box-container">
     ...
     <form action="" method="post" class="box">
        ...
        <?php else: ?>
           <a href="login.php" class="btn" style="background-color: #ccc;">Login to Add</a>
        <?php endif; ?>
     </form>
      <?php
         }
...
<section class="home-contact">
   <div class="content">
      ...
      <p>Click below to get all your answers!</p>
